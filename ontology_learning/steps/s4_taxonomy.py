...
if TYPE_CHECKING:
    from ontology_learning.steps.s0_retriever import DocRetriever, TaxonomyParentIndex

from ontology_learning.llm import LLMClient, LLMError, _extract_json
from ontology_learning.models import ExtractedType, TaxonomyResult, TermTypingResult
from ontology_learning.progress import progress_bar
from ontology_learning.prompts import build_s4_cluster_messages, build_s4_depth_messages, build_s4_messages
