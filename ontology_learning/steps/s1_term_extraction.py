...
from ontology_learning.models import ExtractedTerm
from ontology_learning.prompts import build_s1_per_doc_messages

if TYPE_CHECKING:
    from ontology_learning.steps.s0_retriever import DocRetriever
