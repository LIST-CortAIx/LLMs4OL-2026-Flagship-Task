...
from ontology_learning.llm import LLMClient
from ontology_learning.steps import s2_type_extraction
...
_CONFIG_FILE = Path(__file__).resolve().parent.parent / (
...
from ontology_learning.models import (
    ExtractedTerm,
    ExtractedType,
    PipelineOutput,
    RelationResult,
...
def run_s1(args: argparse.Namespace) -> None:
    from ontology_learning.steps import s0_retriever, s1_term_extraction
...
def run_s0(args: argparse.Namespace) -> None:
    ...
    from ontology_learning.steps import s0_retriever
...
def run_s1s2(args: argparse.Namespace) -> None:
    from ontology_learning.steps import s0_retriever, s1_term_extraction, s2_type_extraction
...
def run_s2(args: argparse.Namespace) -> None:
    from ontology_learning.steps import s0_retriever, s2_type_extraction
...
def run_s3(args: argparse.Namespace) -> None:
    from ontology_learning.steps import s0_retriever, s3_term_typing
...
def run_s4(args: argparse.Namespace) -> None:
    from ontology_learning.steps import s4_taxonomy
...
def run_s5(args: argparse.Namespace) -> None:
    from ontology_learning.steps import s5_relations
...
def run_eval(args: argparse.Namespace) -> None:
    from ontology_learning.evaluate import (
